...
const TextBlock = () => {
    ...
    return (
        <div className='w-screen h-screen flex items-end'>
            ...
            <div className='flex gap-4 text-[#9fdcff] text-7xl font-semibold _bg-[red] absolute top-[40%] left-32'>
            ...
            <div className='w-[40%] p-3 bg-[#9fdcff] text-[#292828] rounded-xl z-30 bottom-10 left-32 absolute text-xl flex justify-evenly items-center'>
                ...
                <Link href={"/services"} className='px-4 cursor-pointer py-3 bg-[#292828] text-[#9fdcff] rounded-xl'>{language === "EN" ? "learn more":" mehr erfahren"}</Link> 
            </div>
        </div>
    );
};
